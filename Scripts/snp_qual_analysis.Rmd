...
ggsave("./Figures/Quality_Analysis/medquality_comparison.pdf", height = 1.5, width = 4)
ggsave("./Figures/Quality_Analysis/medquality_comparison.png", height = 1.5, width = 4)
```
