...
```{r}
# Levels
levels <- c("ref_chandler", "tree2", "cr22", "cr13", "cr10", "cr85",
...
qual_table %>%
  ...
  geom_point(aes(color = color_gradient), size = 0.5) +
  scale_color_identity(guide = "legend") +
...
ggsave("./Figures/Quality_Analysis/medquality_comparison_snps_long.pdf", height = 2.81, width = .95)
ggsave("./Figures/Quality_Analysis/medquality_comparison_snps_long.png", height = 2.81, width = .95)
```
...
ggsave("./Figures/Quality_Analysis/medquality_comparison_indels_long.pdf", height = 2.81, width = .95)
ggsave("./Figures/Quality_Analysis/medquality_comparison_indels_long.png", height = 2.81, width = .95)
```
