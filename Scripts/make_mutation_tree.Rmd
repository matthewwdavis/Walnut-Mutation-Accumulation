...
both_plot_obj <- both_plot +
  ...
  theme(legend.position = c(.2,.9),
        ...
        axis.text.x = element_blank())
both_plot_obj
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_both.pdf", height = 2.8, width = 1.5)
...
both_plot +
  ...
  theme(legend.position = c(.05,.8),
        plot.margin = margin(t = 0, r = -3.5, b = 0, l = -.5, unit = "cm"))
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both.pdf", height = 2.75, width = 7.4)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both.png", height = 2.75, width = 7.4)
...
plot_rna <- plot_rna +
  ...
  theme(legend.position = "none",
        ...
        axis.text.x = element_blank())
plot_rna
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_rna.pdf", height = 1.8, width = 0.75)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_rna.png", height = 1.8, width = 0.75)
...
plot_embryo <- plot_embryo +
  ...
  theme(legend.position = "none",
        legend.key.size = unit(.2, units = "cm"),
        plot.margin = margin(t = 0, r = .1, b = -.1, l = -.4, unit = "cm"),
        axis.line.x = element_blank(),
        axis.ticks.x = element_blank(),
        axis.text.x = element_blank())
plot_embryo
