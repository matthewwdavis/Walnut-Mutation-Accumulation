...
both_plot_obj <- both_plot +
  scale_x_continuous(expand = c(0.1,1100)) +
  theme(legend.position = c(.25,.9),
        ...
        axis.text.x = element_blank())
both_plot_obj
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_both.pdf", height = 2.85, width = 1)
...
both_plot +
  ...
  theme(legend.position = c(.175,.9),
        plot.margin = margin(t = 0, r = -1.9, b = 0, l = -0.85, unit = "cm"))
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both.pdf", height = 2.75, width = 3.06)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both.png", height = 2.75, width = 3.06)
