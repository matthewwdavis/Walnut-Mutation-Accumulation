...
```{r}
set.seed(25)
both_filt <- mutations[medQUAL >= 30 & medDPREAL >= 15 & MAPP == T]
...
## Only embryos
```{r}
embryo_only <- mutations[medQUAL >= 30 & medDPREAL >= 15 & MAPP == T & CULTURETYPE == "embryo"]
...
both_plot_obj <- both_plot +
  scale_x_continuous(expand = c(0.1,1)) + # This line is adjusted for different labeling needs
  theme(legend.position = "none",
        plot.margin = margin(t = 0, r = 0, b = -.1, l = -.5, unit = "cm"),
        axis.line.x = element_blank(),
        axis.ticks.x = element_blank(),
        axis.text.x = element_blank(),
...
both_plot_obj
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_both.pdf", height = 3.78, width = 2.2)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_presentation_lables_both.pdf", height = 4.97, width = 2)
...
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both.pdf", height = 2.8, width = 3.06)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both.png", height = 2.8, width = 3.06)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both_presentation.pdf", height = 3.33, width = 6.6)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_both_presentation.png", height = 3.33, width = 6.6)
```
...
plot_rna <- plot_rna +
  scale_x_continuous(expand = c(0.1,3000)) +
  theme(legend.position = "none",
        ...
        axis.text.x = element_blank())
plot_rna
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_rna.pdf", height = 1.4, width = 0.5)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_rna.png", height = 1.4, width = 0.5)
...
plot_embryo
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_embryos.pdf", height = 1.8, width = 0.75)
ggsave("./Figures/Phylogeny/all_sample_branch_is_mut_for_lables_embryos.png", height = 1.8, width = 0.75)
