...
ggplot(real_tests[padjust<0.05], aes(x = START, col = stat > 0, y = sig)) +
  ...
  scale_color_manual(values = c("orangered2", "royalblue")) +
...
ggsave("./Figures/RNA_Sequencing/clade_gene_diff_expression_chr12_del.pdf", height = 1, width = 2)
ggsave("./Figures/RNA_Sequencing/clade_gene_diff_expression_chr12_del.png", height = 1, width = 2)
```