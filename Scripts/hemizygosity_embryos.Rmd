...
point_plot <- function(vcf, het_color = "deepskyblue4", hom_color = "darksalmon",
                       quality = 0, col_num = 1, samples = c("ref_chandler", "tree2", "cr2_hifi", "cr85", "cr10",
...
```{r}
point_plot(chr11_an, col_num = 2, samples = c("cr2_hifi", "cr2_16A", "cr2_16A1", "cr2_16A2",
                                              "cr2_17A1", "cr2_17A2", "cr2_18A1"))
#ggsave("./Figures/Hemizygosity/chr11_position_depth_genotype.png", height = 5, width = 7)

point_plot(chr12_an, samples = c("cr2_15A", "cr2_15A1"))
#ggsave("./Figures/Hemizygosity/chr12_position_depth_genotype.png", height = 3, width = 4)

point_plot(chr16_an, col_num = 2, samples = c("cr2_hifi", "cr2_15A", "cr2_15A1", "cr2_16A", "cr2_16A1",
                                 "cr2_16A2", "cr2_17A1", "cr2_17A2", "cr2_18A", "cr2_18A1"))
...
ggplot(aes(x = POS, y = depth_count_log, color = type)) +
  ...
  facet_wrap(~ Source) +
  labs(x = "Position (Mb)",
       y = "Depth per Window (natural log)",
       color = "Genotype") +
  theme_classic()
```
