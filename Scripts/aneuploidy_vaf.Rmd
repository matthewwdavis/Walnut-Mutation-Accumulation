...
test %>%
  ...
  #geom_hline(yintercept = 0.5, linetype = 3) +
  facet_grid(SOURCE~CHROM + Haplotype, space = "free", switch = "y") +
  scale_color_manual(values = c(dup = "orangered3", del = "royalblue1", "none"  = "grey75")) +
  scale_y_continuous(limits = c(0,1), breaks = c(0.5), position = "left") +
  labs(x = "Position", y = "Allele Frequency") +
  theme_classic(base_size = 6) +
  theme(
    strip.background = element_blank(),
...
ggsave("./Figures/Aneuploidy_VAF/all_samples_phased_250_windows_chr_49111216.pdf", height = 2.5, width = 3.5)
ggsave("./Figures/Aneuploidy_VAF/all_samples_phased_250_windows_chr_49111216.png", height = 3, width = 3.5)
```
