...
## add color columns
link_899[, color := fifelse(QSEQID %in% "1792_3_382285_A_1", "firebrick4", "#7287eb") ]
link_899 <- link_899[order(link_899$color), ]
link_5453[, color := fifelse(StartChr %in% "7B", "skyblue4", "#eb7287")]
link_5453 <- link_5453[order(link_5453$color), ]
```
...
```{r}
par(mar = c(0, 0, 0, 0))
pdf("./Figures/Transposable_Elements/circos_899.pdf", height = 2.6, width = 2.6)
# Set smaller padding
...
```{r}
par(mar = c(0, 0, 0, 0))
pdf("./Figures/Transposable_Elements/circos_5453.pdf", height = 2.6, width = 2.6)
# Set smaller padding
circos.par(track.margin = c(0.005, 0.005), start.degree = 90, circle.margin = .01)
