...
# Create table to plot summaries
plot.table <- sample_sums.df %>%
  group_by(Source) %>%
...
plot.table <- group_info(plot.table)
sample_sums.df <- group_info(sample_sums.df)

# Set levels for plotting
plot.table$Source <- factor(plot.table$Source, levels = levels)
...
## First look at shoot mutation rate
