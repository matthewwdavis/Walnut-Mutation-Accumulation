...
chr.table %>%
  ggplot(aes(x = as.factor(seq_id), y = tpm_by_efflength, fill = Group)) + 
  geom_bar(stat = "identity") +
  facet_wrap(~ Source, scales = "free") +
  scale_fill_manual(values = c("chr_4" = "red", "chr_9" = "red", "Other" = "gray")) +
...
all_counts %>%
  ggplot(aes(x = as.factor(seq_id), y = log(est_counts/length), fill = Group)) + 
  geom_boxplot() +
  facet_wrap(~Source, scales = "free") +
  scale_fill_manual(values = c("chr_4" = "red", "chr_9" = "red", "Other" = "gray")) +
  labs(x = "Chromosome", y = "RNA Count / total exon length") +
  theme_classic() +
  theme(legend.position = "none")
...
all_counts %>%
  ggplot(aes(x = as.factor(seq_id %in% c(4,9)), y = log(tpm/length), fill = Group)) + 
  geom_boxplot() +
  facet_wrap(~Source, scales = "free") +
  scale_fill_manual(values = c("chr_4" = "red", "chr_9" = "red", "Other" = "gray")) +
  labs(x = "Chromosome", y = "TPM / Length") +
  theme_classic() +
  theme(legend.position = "none")
# Where is there nothing when looking at the boxplots of the genes?
```
