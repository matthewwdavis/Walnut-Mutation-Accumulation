...
ggsave("./Figures/RNA_Sequencing/expression_heatmap_all_dups.pdf", height = 1.45, width = 2.7)
ggsave("./Figures/RNA_Sequencing/expression_heatmap_all_dups.png", height = 1.45, width = 2.7)
```
