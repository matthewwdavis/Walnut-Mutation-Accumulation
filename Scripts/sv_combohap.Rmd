...
ggsave("./Figures/SV_Calling/cr2_dn_sv_histogram.pdf", height = 1.375, width = 2.16)
ggsave("./Figures/SV_Calling/cr2_dn_sv_histogram.png", height = 1.375, width = 2.16)
```
...
sv %>%
  ...
  labs(x = "Length of variant (bp)", y = "Number of variants (bp)", title = "Reference and Tree") +
  theme_classic(base_size = 6) +
  theme(
    legend.key.size = unit(0.2, "cm"),
    legend.title = element_blank(),
...
ggsave("./Figures/SV_Calling/ref_term_chandler_dn_sv_histogram.pdf", height = 1.375, width = 2.16)
ggsave("./Figures/SV_Calling/ref_term_chandler_dn_sv_histogram.png", height = 1.375, width = 2.16)
```
