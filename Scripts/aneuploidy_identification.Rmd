...
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/ref_chandler_depth_diff_per_chr.pdf", height = 4, width = 8)
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/ref_chandler_depth_diff_per_chr.png", height = 4, width = 8)

real_v_sim_plot(test_combined, difference_type = "Depth_Difference_Term")
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/term_chandler_depth_diff_per_chr.pdf", height = 4, width = 8)
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/term_chandler_depth_diff_per_chr.png", height = 4, width = 8)

real_v_sim_plot(test_combined, difference_type = "Depth_Difference_Cr2")
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/cr2_depth_diff_per_chr.pdf", height = 4, width = 8)
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/cr2_depth_diff_per_chr.png", height = 4, width = 8)

real_v_sim_plot(test_combined, difference_type = "Depth_Difference_Cr2", specified_chromosomes = c(1,4,9))
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/cr2_depth_diff_chr149.pdf", height = 3, width = 7)
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/cr2_depth_diff_chr149.png", height = 3, width = 7)

real_v_sim_plot(test_combined, difference_type = "Depth_Difference_Ref", specified_chromosomes = c(1,4,9))
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/ref_depth_diff_chr149.pdf", height = 3, width = 7)
#ggsave("~/Projects/Walnut/Mutation_Accumulation/Figures/Aneuploidy_Identification/ref_depth_diff_chr149.png", height = 3, width = 7)

real_v_sim_plot(test_combined, difference_type = "Depth_Difference_Term", specified_chromosomes = c(1,4,9))
#ggsave("./Figures/Aneuploidy_Identification/term_depth_diff_chr149.pdf", height = 3, width = 7)
#ggsave("./Figures/Aneuploidy_Identification/term_depth_diff_chr149.png", height = 3, width = 7)
...
combo_haps %>%
  ...
  scale_fill_manual(values = c("cr2_Scaled_REF_DP.hap1" = "orangered", "ref_Scaled_REF_DP.hap1" = "seagreen",
                               "term_Scaled_REF_DP.hap1" = "seagreen", "cr2_Scaled_ALT_DP.hap2" = "orangered",
                               "ref_Scaled_ALT_DP.hap2" = "seagreen", "term_Scaled_ALT_DP.hap2" = "seagreen"),
                      name = NULL,
                      breaks = c("cr2_Scaled_REF_DP.hap1", "ref_Scaled_REF_DP.hap1", "term_Scaled_REF_DP.hap1"),
                      labels = c("HiFi Embryo", "Reference Tree", "Tree 2"))


#ggsave("./Figures/Aneuploidy_Identification/depth_boxplots_by_haplotype.pdf", height = 4, width = 12)
#ggsave("./Figures/Aneuploidy_Identification/depth_boxplots_by_haplotype.png", height = 4, width = 12)
```
...
ggsave("./Figures/Aneuploidy_Identification/cr2_depth_diff_chr149_sim_only.pdf", height = 3, width = 7)
ggsave("./Figures/Aneuploidy_Identification/cr2_depth_diff_chr149_sim_only.png", height = 3, width = 7)

real_v_sim_plot(combined_df = test_combined, difference_type = "Depth_Difference_Ref",
                specified_chromosomes = c(1, 4, 9), exclude_source = "Observed")
ggsave("./Figures/Aneuploidy_Identification/ref_depth_diff_chr149_sim_only.pdf", height = 3, width = 7)
ggsave("./Figures/Aneuploidy_Identification/ref_depth_diff_chr149_sim_only.png", height = 3, width = 7)

real_v_sim_plot(combined_df = test_combined, difference_type = "Depth_Difference_Term",
                specified_chromosomes = c(1, 4, 9), exclude_source = "Observed")
ggsave("./Figures/Aneuploidy_Identification/term_depth_diff_chr149_sim_only.pdf", height = 3, width = 7)
ggsave("./Figures/Aneuploidy_Identification/term_depth_diff_chr149_sim_only.png", height = 3, width = 7)
```
