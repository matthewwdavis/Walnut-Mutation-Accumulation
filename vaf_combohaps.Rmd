...
## Create a list of tables with quality scores increasing by 5
```{r}
...
plot_levels <- c("cr16a2", "cr16a1", "cr17a2", "cr17a1", "cr18a1","cr16a", "cr2_hifi",
                 ...
                 "cr11a", "cr85", "cr10", "cr13", "cr22", "tree2", "ref_chandler")
...
mut_qual %>%
  ...
  theme(
    ...
    plot.margin = margin(t = 0.1, r = 0.05, b = 0, l = 0, unit = "cm")
  )
ggsave("./Figures/VAF_Analysis/all_samples_vaf_combohap.pdf", height = 3.925, width = 1.65)
ggsave("./Figures/VAF_Analysis/all_samples_vaf_combohap.png", height = 3.925, width = 1.65)
```
